...
const ClassicColorPicker = (props: ColorPickerProps) => {
    ...
    return (<div className={props.className}>
        ...
        <div className="color-picker">
            <input ref={target} name={id} id={id} type="text" className="color-preview btn-appearance" autoComplete="off" spellCheck="false" placeholder={props.placeholder || "Select colour"}
                value={colorValue}
                onChange={(e) => {
